namespace Env.CnemcPublish.DAL
{
    ...
    public sealed class AQIDataPublishHistory : Entity
    {
        ...
        [DataMember, RoundtripOriginal, StringLength(10)]
        public string Area
        {
            get
            {
        ...
        [DataMember, StringLength(8), RoundtripOriginal]
        ...
        [DataMember, RoundtripOriginal, StringLength(40)]
        ...
        [DataMember, Key, Editable(false, AllowInitialValue=true), RoundtripOriginal, StringLength(5)]
        ...
        [Column(Order =1)]
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        [RoundtripOriginal, DataMember, Editable(false, AllowInitialValue=true), Key]
